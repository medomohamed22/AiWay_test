...
const TASKS={
 ...
 'all-models':{ar:['وضع المحترف','اختر من نماذج الذكاء الاصطناعي المختلفة واختر النموذج الأنسب لك.','اختيار يدوي للنموذج'],en:['Pro Mode','Choose from different AI models and select the model that suits you best.','Manual model selection']}
};
