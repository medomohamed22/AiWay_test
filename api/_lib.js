...
export const DEFAULT_AI_TOOLS = [
  ...
  {id:'all-models',name_ar:'كل نماذج الذكاء الاصطناعي',name_en:'All AI Models',description_ar:'اختر من نماذج الذكاء الاصطناعي المختلفة واختر النموذج الأنسب لك.',description_en:'Choose from different AI models and select the model that suits you best.',tool_type:'text',model_id:'deepseek/deepseek-v4-flash',prompt_config:{_ui:{icon_svg:'<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M4 4h6v6H4V4Zm10 0h6v6h-6V4ZM4 14h6v6H4v-6Zm10 0h6v6h-6v-6Z"/></svg>'}},is_active:true,sort_order:5},
